                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        <div class="table-header">
                            ...
                            <b-modal :hide-footer="true" id="exampleModalCenter" :title="in_edit ? 'Editar usuario' : 'Cadastrar usuario'" centered>
                                ...
                                <b-form class="simple-example" novalidate @submit.stop.prevent="record">
                                        <b-form-row>
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.name}">Informe o nome do usuario</b-form-invalid-feedback>
                                            </div>
                                        </b-form-row>
                                        <b-form-row>
                                            <div class="col-md-12 mb-4">
                                                <label for="fullName">Email</label>
                                                <b-input id="fullName" v-model="form.email" placeholder="" :class="[submit_form ? (form.email ? 'is-valid' : 'is-invalid') : '']"></b-input>
                                                
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.email}">Informe o email do usuario</b-form-invalid-feedback>
                                            </div>
                                        </b-form-row>
                                        <b-form-row>
                                            <div class="col-md-12 mb-4">
                                                <label for="fullName">Senha</label>
                                                <b-input id="fullName" v-model="form.password" placeholder="" :class="[submit_form ? (form.password ? 'is-valid' : 'is-invalid') : '']"></b-input>
                                                
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.email}">Informe a senha do usuario</b-form-invalid-feedback>
                                            </div>
                                        </b-form-row>
                        ...
                        <b-table emptyText="Nenhuma usuario encontrado." ref="basic_table" responsive hover :items="items" :fields="columns" :per-page="table_option.page_size" :current-page="table_option.current_page" :filter="table_option.search_text"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            delete_row(item) {
                if (confirm('Deseja excluir o usuario '+item.name+'?')) {
