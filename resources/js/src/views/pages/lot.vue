                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        <div class="table-header">
                            ...
                            <b-modal :hide-footer="true" id="exampleModalCenter" :title="in_edit ? 'Editar lote' : 'Cadastrar lote'" centered>
                                
                                <b-form class="simple-example" novalidate @submit.stop.prevent="record">
                                        <b-form-row>
                                            <div class="col-md-12 mb-4">
                                                <label for="fullName">Nome do lote</label>
                                                <b-input id="fullName" v-model="form.name" placeholder="" :class="[submit_form ? (form.name ? 'is-valid' : 'is-invalid') : '']"></b-input>
                                                
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.name}">Informe o nome do lote</b-form-invalid-feedback>
                                            </div>
                                            <div class="col-md-12 mb-4">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                <label for="fullName">Quantidade</label>
                                                <b-input type="number" id="fullName" v-model="form.qnt_products" placeholder="" :class="[submit_form ? (form.qnt_products ? 'is-valid' : 'is-invalid') : '']"></b-input>
                                                
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.qnt_products}">Informe a quantidade</b-form-invalid-feedback>
                                            </div>
                                        </b-form-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            record(){
                ...
                if(this.validation()){
                    ...
                    if(this.in_edit){
                        ...
                        axios.put('/api/lot/'+this.form.id, this.form)
                        .then(response => {
                            this.getLotes()
            ...
            delete_row(item) {
                if (confirm('Deseja excluir 1 produto do lote '+item.lot.name+'?')) {

                    axios.delete('/api/lot/'+item.id)
                    .then(response => {
