                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        <div class="table-header">
                            ...
                            <b-modal :hide-footer="true" id="exampleModalCenter" :title="in_edit ? 'Editar modelo' : 'Cadastrar modelo'" centered>
                                
                                <b-form class="simple-example" novalidate @submit.stop.prevent="record">
                                        <b-form-row>
                                            <div class="col-md-6 mb-4">
                                                <label for="fullName">Nome do modelo</label>
                                                <b-input id="fullName" v-model="form.name" placeholder="" :class="[submit_form ? (form.name ? 'is-valid' : 'is-invalid') : '']"></b-input>
                                                
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.name}">Informe o nome do modelo</b-form-invalid-feedback>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <label for="fullName">Marca</label>

                                                <multiselect 
                                                    :class="[submit_form ? (form.brand ? 'is-valid' : 'is-invalid') : '']" 
                                                    v-model="form.brand" 
                                                    :options="brands" 
                                                    :searchable="true" 
                                                ...
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.brand}">Informe a marca</b-form-invalid-feedback>
                                            </div>
                                        </b-form-row>
                                        <b-form-row>
                                            <div class="col-md-6 mb-4">
                                                <label for="fullName">Ano</label>
                                                <b-input type="number" id="fullName" v-model="form.year" placeholder="" :class="[submit_form ? (form.year ? 'is-valid' : 'is-invalid') : '']"></b-input>
                                                
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.year}">Informe o ano do modelo</b-form-invalid-feedback>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <label for="fullName">Número de série</label>
                                                <b-input id="fullName" v-model="form.serial_number" placeholder="" :class="[submit_form ? (form.serial_number ? 'is-valid' : 'is-invalid') : '']"></b-input>
                                                
                                                <b-form-invalid-feedback :class="{'d-block' : submit_form && !form.serial_number}">Informe o número de série</b-form-invalid-feedback>
                                            </div>
                                        </b-form-row>
                        ...
                        <b-table emptyText="Nenhum modelo encontrado." ref="basic_table" responsive hover :items="items" :fields="columns" :per-page="table_option.page_size" :current-page="table_option.current_page" :filter="table_option.search_text"
        ...
        methods: {
            ...
            record(){
                ...
                if(this.validation()){
                    ...
                    this.form.brand_id = this.form.brand.id

                    if(this.in_edit){

                        axios.put('/api/modelo/'+this.form.id, this.form)
                        .then(response => {
                            this.getModels()
                        ...
                        axios.post('/api/modelo', this.form)
                        .then(response => {
                            this.getModels()
                            this.$bvModal.hide('exampleModalCenter')
                            this.form = this.resetForm()
            ...
            delete_row(item) {
                if (confirm('Deseja excluir o modelo '+item.name+'?')) {

                    axios.delete('/api/modelo/'+item.id)
                    .then(response => {
                    ...
                    .catch(error => {
                        ...
                        this.$swal({
                            title: 'Erro ao excluir modelo. Excluir drones cadastrados para esse modelo.',
                            padding: '2em'
                        });
