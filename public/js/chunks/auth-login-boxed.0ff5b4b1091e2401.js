...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/api/auth', this.form).then(function (resp) {
        console.log('resp', resp); //Cookies.set('auth_token', token, { expires: 7, secure: true, sameSite: 'Strict' });
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("b-input", {
                        ...
                        model: {
                          value: _vm.form.pasword,
                          callback: function ($$v) {
                            _vm.$set(_vm.form, "pasword", $$v)
                          },
                          expression: "form.pasword",
                        },
                      }),
                    ],
                    1
